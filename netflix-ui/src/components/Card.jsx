...
import { removeFromUserLikedMovies } from '../store'
                ...
                <div className="info-container flex column">
                    ...
                    <div className="icons flex j-between">
                        <div className="controls flex">
                            ...
                            {isLiked ? 
                            <BsCheck title = "remove from my list" onClick = {()=>{dispatch(removeFromUserLikedMovies({email:email, movieId:movieData.id}))}}/> 
                            :
...
const Container = styled.div`
    ...
    .hover{
        ...
        bax-shadow : rgba(0, 0, 0, 0.75), 0px, 3px, 10px;
